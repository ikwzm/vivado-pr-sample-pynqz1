...
set     design_bd_tcl_file  [file join $script_directory "rpc_server_bd.tcl"  ]
lappend ip_repo_path_list   [file join $script_directory ".." "ip"]
source  [file join $script_directory ".." ".." ".." "base" "base_settings.tcl"]
#
# Create project
#
